...
public class ConversionesActivity extends AppCompatActivity {
    ...
    String url="http://51.222.31.68:5000/api/ejercicios/generadorConversiones";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tiempotxt=findViewById(R.id.txtContad);
        problemaTxv=(TextView) findViewById(R.id.txv_problema4);
        ...
        aceptar=(Button) findViewById(R.id.btn_aceptar4);
        //Inicio Contador
        termino=false;
        ...
        AndroidNetworking.get(url).build().getAsJSONObject(new JSONObjectRequestListener() {
            ...
            public void onError(ANError anError) {
                Toast.makeText(ConversionesActivity.this, "Ocurrio un error contactese con el administrador", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        aceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(respSeleccionada.equals(respCorrec)){
                    Toast.makeText(ConversionesActivity.this, "Correcto!", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(ConversionesActivity.this, "Incorrecto", Toast.LENGTH_SHORT).show();
                }
